...
import {CriticalConfirmationModalProps} from "@/types/Modals";

const CriticalConfirmationModal: React.FC<CriticalConfirmationModalProps> = ({
                                                                                 isVisible,
                                                                                 onClose,
                                                                                 onConfirmed,
                                                                                 title,
                ...
                >
                    ...
                    >
                        <div className="text-center">
                            <CircleX className="text-danger mx-auto mt-3 h-16 w-16"/>
                            <motion.h3
                        ...
                        <div className="mt-6 flex justify-center gap-x-3">
                            ...
                            <button
                                ...
                                dark:focus:ring-slate-700 dark:focus:ring-opacity-50
                                [&:hover:not(:disabled)]:bg-opacity-90 [&:hover:not(:disabled)]:border-opacity-90
                                bg-danger border-danger text-white dark:border-danger w-24"
                            >
                                {btnText}
                            </button>
                        </div>
...
export default CriticalConfirmationModal;
